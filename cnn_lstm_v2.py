...
seq.add(Convolution2D(512,5,5,border_mode='same',
				input_shape=(1,53,53)))
...
seq.add(Convolution2D(1024,3,3))
seq.add(Activation('relu'))
...
#weight file name
weight_file = '../weights/cnn_lstm_weight_v2.h5'
...
np.save('../predictions/pred-cnn_v2.npy',pred)
